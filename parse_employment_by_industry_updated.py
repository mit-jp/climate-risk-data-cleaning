...
df1.iloc[740,:],df1.iloc[741,:]=df.iloc[741,:],df1.iloc[740,:]
...
#df1.iloc[3097,:],df1.iloc[3098,:]=df.iloc[3098,:],df.iloc[3097,:]
#df1.iloc[3124,:],df1.iloc[3125,:]=df.iloc[3125,:],df.iloc[3124,:]
df = df1
del(df1)
